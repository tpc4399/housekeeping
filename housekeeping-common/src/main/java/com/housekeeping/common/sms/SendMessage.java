...
public class SendMessage{
    ...
    public static void sendMessage2(String nationCode, String phoneNumber, String[] param) throws Exception {
        // 短信应用SDK AppID
        ...
        try {
            ...
            SmsSingleSenderResult result = ssender.sendWithParam(nationCode, phoneNumber,
                    templateId, param, smsSign, "", "");  // 签名参数未提供或者为空时，会使用默认签名发送短信
    ...
    public static void sendMessage(String nationCode, String phoneNumber, String[] param) throws IOException {
        ...
        params.append("&dstaddr="+nationCode+phone);
        String s = new StringBuilder().append("【1快找】您的驗證碼為").append(param[0]).append("(有效期為").append(param[1]).append("分鐘),為了安全考慮，請勿將該驗證碼轉發給他人").toString();
        params.append("&smbody="+s);
    ...
    public static void main(String[] args) {
        String[] arr = {"建明同学"};
        sendWorkStartMessage("86","15302657044",arr);
    }
}
