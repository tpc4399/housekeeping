...
public class ScoreCalculation {
    ...
    //可工作区域分
    private Float getScope7() {
        Float maxScope = new Float(weight.get(ApplicationConfigConstants.areaScopeDouble));
        return variable3?maxScope:new Float(0);
    }
    ...
    public Float scope(){
        ...
        Float scope7 = new Float(0); //可工作区域分
        if (priorityType == 0){
            scope1 = getScope1();
            scope2 = getScope2();
            scope3 = getScope3();
