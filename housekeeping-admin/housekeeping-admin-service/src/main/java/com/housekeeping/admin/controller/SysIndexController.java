...
public class SysIndexController {
   ...
   /* @Access({RolesEnum.SYSTEM_ADMIN})
    ...
    @ApiOperation("主页搜索,新接口 2021-6-22 14:12")
    @PostMapping("/query3")
    public R query3(@RequestBody QueryDTO dto) throws InterruptedException {
        return queryService.query3(dto);
    }

    @ApiOperation("主页搜索,新接口 2021-7-13 16:48")
    @PostMapping("/query4")
    public R query4(@RequestBody QueryDTO dto) throws InterruptedException {
        return queryService.query4(dto);
    }
    ...
    public R getCal(Integer year,Integer month){
        return sysIndexService.getCal(year, month);
    }
