...
public class AdminController {
    ...
    @HystrixCommand
    public R checkDataAdmin(@PathVariable("data")String data, @PathVariable("type")String type) throws InterruptedException {
        R r = this.userService.checkData(data, type,1);
        return r;
    }
