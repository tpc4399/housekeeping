...
public interface EmployeesDetailsService extends IService<EmployeesDetails> {
    ...
    EmployeesDetails getByUserId(Integer userId);
    ...
    R cusPage6(Page page, PageOfEmployeesDetailsDTO pageOfEmployeesDetailsDTO, Integer manId);

    R cusPage7(Page page, PageOfEmployeesDetailsDTO pageOfEmployeesDetailsDTO);

    R search(SearchEmployees searchEmployees);

    R getPersonal(Page page,PageOfEmployeesDTO pageOfEmployeesDTO);

    R getCollect(Integer empId);
}
