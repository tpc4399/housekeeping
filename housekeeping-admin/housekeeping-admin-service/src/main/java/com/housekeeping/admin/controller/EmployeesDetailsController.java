...
import com.housekeeping.admin.dto.EmployeesSkillDTO;
...
import com.housekeeping.admin.vo.SearchEmployees;
...
public class EmployeesDetailsController {
    ...
    @ApiOperation("【公司】【经理】【员工】【個體戶】修改员工技能标签")
    ...
    @Access({RolesEnum.USER_COMPANY,RolesEnum.USER_MANAGER,RolesEnum.USER_EMPLOYEES,RolesEnum.USER_PERSONAL})
    @ApiOperation("【公司】【经理】【员工】【个体户】查詢该公司所有員工")
    @LogFlag(description = "查詢員工")
    @GetMapping("/page2")
    ...
    @Access({RolesEnum.USER_COMPANY,RolesEnum.USER_MANAGER})
    @ApiOperation("【公司】【經理】查詢该公司所有員工(返回工作年限)")
    @LogFlag(description = "查詢員工")
    @GetMapping("/page5")
    ...
    @Access({RolesEnum.USER_MANAGER})
    @ApiOperation("【經理】查詢该公司所有員工(返回工作年限)")
    @LogFlag(description = "查詢員工")
    @GetMapping("/page7")
    public R page7(Page page, PageOfEmployeesDetailsDTO pageOfEmployeesDetailsDTO){
        return employeesDetailsService.cusPage7(page, pageOfEmployeesDetailsDTO);
    }

    @Access({RolesEnum.USER_COMPANY,RolesEnum.USER_MANAGER})
    @ApiOperation("【公司】【經理】查詢經理下所有員工(返回工作年限)")
    @GetMapping("/page6")
    public R page6(Page page, PageOfEmployeesDetailsDTO pageOfEmployeesDetailsDTO,Integer manId){
        return employeesDetailsService.cusPage6(page, pageOfEmployeesDetailsDTO,manId);
    }
    ...
    @ApiOperation("首頁公司搜索保潔員")
    @GetMapping("/search")
    public R search(SearchEmployees searchEmployees){
        return employeesDetailsService.search(searchEmployees);
    }

    @ApiOperation("查看員工收藏量")
    @GetMapping("/getCollect")
    public R getCollect(Integer empId){
        return employeesDetailsService.getCollect(empId);
    }
