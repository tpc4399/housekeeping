...
public interface IOrderDetailsService extends IService<OrderDetails> {
    ...
    * */
    ...
    R queryByAdmin(Integer type, Page page);
    ...
    R getWorkTimeTableByEmp(TimeTableByEmpDTO dto);

    R getWorkTimeTableByMan(TimeTableByManDTO dto);
    ...
    R getRefundByNumber(String number);


    R newQueryByCom(Integer type);

    R getTokenOrder(String number,Integer type);

    List<OrderDetailsPOJO> getOrderByEmpId(Integer empId);
}
