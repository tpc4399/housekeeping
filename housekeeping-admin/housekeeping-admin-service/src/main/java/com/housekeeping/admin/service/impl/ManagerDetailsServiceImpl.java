...
public class ManagerDetailsServiceImpl extends ServiceImpl<ManagerDetailsMapper, ManagerDetails> implements ManagerDetailsService {
    ...
    public R saveEmp(ManagerDetailsDTO managerDetailsDTO) {
        ...
        Integer maxManagerId = 0;
            if(CommonUtils.isNotEmpty(managerDetailsDTO)){
                ...
                if(managerDetailsDTO.getHeadUrl()!=null&&!managerDetailsDTO.getHeadUrl().equals("")){
                    managerDetails.setHeadUrl(managerDetailsDTO.getHeadUrl());
                }else {
        ...
        return R.ok(maxManagerId,"添加經理成功");
    }
    ...
    public R saveEmp2(AddManagerDetailsDTO dto) {
        ...
        if(dto.getHeadUrl()!=null&&!dto.getHeadUrl().equals("")){
            managerDetails.setHeadUrl(dto.getHeadUrl());
        }else {
            managerDetails.setHeadUrl("https://test-live-video.oss-cn-shanghai.aliyuncs.com/HKFile/ImPhoto/userId=/20210508110600.png");
        }
    ...
    @Override
    public ManagerDetails getByUser(Integer userId) {
        QueryWrapper qw = new QueryWrapper();
        qw.eq("user_id", userId);
        ManagerDetails managerDetails = this.getOne(qw);
