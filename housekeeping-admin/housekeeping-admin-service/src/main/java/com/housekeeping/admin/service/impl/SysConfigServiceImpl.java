        ...
        if (CommonUtils.isNotEmpty(priorityType)){
            switch (priorityType){
                case 1: map.put(
                        ...
                        String.valueOf(new Double(map.get(ApplicationConfigConstants.distanceScoreDouble))+new Double(100.0))
                );
                    break;
                case 2: map.put(
                        ApplicationConfigConstants.areaScopeDouble,
                        String.valueOf(new Double(map.get(ApplicationConfigConstants.areaScopeDouble))+new Double(100.0))

                );
                    break;
                case 3: map.put(
                        ApplicationConfigConstants.priceScopeDouble,
                        String.valueOf(new Double(map.get(ApplicationConfigConstants.priceScopeDouble))+new Double(100.0))

                );
                    break;
                case 4: map.put(
                        ApplicationConfigConstants.attendanceScopeDouble,
                        String.valueOf(new Double(map.get(ApplicationConfigConstants.attendanceScopeDouble))+new Double(100.0))
                );
                    break;
                case 5: map.put(
                        ApplicationConfigConstants.evaluateScopeDouble,
                        String.valueOf(new Double(map.get(ApplicationConfigConstants.evaluateScopeDouble))+new Double(100.0))
