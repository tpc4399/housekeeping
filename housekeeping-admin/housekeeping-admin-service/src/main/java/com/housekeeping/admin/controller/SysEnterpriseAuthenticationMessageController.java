...
public class SysEnterpriseAuthenticationMessageController {
    ...
    public R isValidate(){
        return R.ok(sysEnterpriseAuthenticationMessageService.isValidate());
    }
    ...
    public R query(Page page,Integer status){
        return sysEnterpriseAuthenticationMessageService.query(page,status);
    }
    ...
    public R sendSms(@RequestParam String phone,
                     @RequestParam String prefixPhone) throws Exception {
