...
public class OrderDetailsPOJO extends OrderDetailsParent{
    ...
    public OrderDetailsPOJO(OrderDetails od) {
        ...
        this.companyId = od.getCompanyId().toString();
        ...
        this.lng = od.getLng();
        this.lat = od.getLat();
        this.platformFeeCus = od.getPlatformFeeCus();
        this.platformFeeEmp = od.getPlatformFeeEmp();
        ...
        this.contractImageUrl = od.getContractImageUrl();
        this.contractName = od.getContractName();
